...
<body>
    <header>
        <div class="container-fluid pt-3 px-5 mb-5">
            <div class="row pb-3">
                ...
                <div class="col-8 px-0 d-flex justify-content-end align-items-center">
                    <nav class="navbar">
                        <ul class="d-lg-flex justify-content-end m-0 p-0 gap-4 gap-lg-5">
                            <li class="list-group-item">
                                <a class="nav-link text-uppercase fw-bold" href="index.php">
                                    accueil
                                </a>
                            </li>
                            ...
                            <li class="list-group-item">
                                ...
                                <ul class="px-0 py-2">
                                    ...
                                    <li>
                                        <a href="./pages/apropos.html" class="nav-link fw-bold text-uppercase">
                                            à propos
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="./pages/formations.html" class="nav-link fw-bold text-uppercase">
                                            nos formations
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="list-group-item">
                                <a class="nav-link text-uppercase fw-bold" href="#">historique</a>
                                <ul class="px-0 py-2 lh-lg">
                                    <li>
                                        <a href="./pages/historique2020.html"
                                            class="nav-link fw-bold text-uppercase">2020</a>
                                    </li>

                                    <li>
                                        <a href="./pages/historique2021.html" class="nav-link fw-bold text-uppercase">
                                            2021
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="list-group-item">
                                ...
                                <ul class="px-0 py-2 lh-lg">
                                    <li>
                                        <a href="./pages/contact.html" class="nav-link fw-bold text-uppercase">prendre
                                            contact</a>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <div id="list_icon ">
                        <i id="icon_darkmode" class="fa fa-moon fs-6 text-black"></i>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid" id="heading">
            <div class="row">
                <div class="col-lg-6 d-flex align-items-center text_heading pt-3">
                    <div class="p-3 text-center">
                        ...
                        <div class="subtitle text-center">
                            <p class="fs-4 fw-bolder lh-lg">
                                ...
                                <br />
                                <span>Une passerelle vers l'employabilité des
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            <i class="fa-solid fa-arrow-right pe-3 fs-2 text-white"></i>
                            <button class="btn bg-white">
                                <a href="#" class="nav-link">En savoir plus</a>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <figure class="m-lg-5 m-md-5">
                        <img src="./assets/imgs/photo_grp.png" alt="" width="100%" />
    ...
    <main>
        <div class="container-fluid py-5">
            <div class="row">
                <div class="col-lg d-flex align-items-center justify-content-center d-none d-lg-block">
                    <img src="./assets/imgs/subscribe.png" alt="" width="80%" />
                </div>
                ...
                <div class="col-lg">
                    <div class="d-flex align-items-center justify-content-center py-5">
                        <div class="px-3">
                            ...
                            <div class="mt-5">
                                <p class="m-0 fs-3 lh-lg subtitle fw-bold" id="subscribe">
                    ...
                    <div>
                        <div class="d-flex align-items-center justify-content-center py-5">
                            <img src="./assets/imgs/flèche_down.png" alt="" width="100px" />
                        </div>
                        <div class="d-flex align-items-center justify-content-center">
                            <form action="./assets/php/inscription.php">
                                <button type="submit" class="button type" id="subscribe_btn">
        ...
        <div class="container-fluid my-5">
            <div class="row">
                ...
                <div class="row my-3">
                    <div class="col references py-5 px-3 subtitle text-white">
                        <p class="text-uppercase fw-bold sous_titre yellow_color">
                            passion for humanity
                        </p>
                        ...
                        <p>
                            ...
                            <span>
                                <a href="http://passion4humanity.com" target="_blank">http://passion4humanity.com
                                </a>
                            </span>
                        </p>
                    </div>
                    ...
                    <div class="col d-none d-lg-flex justify-content-center align-items-center">
                        <div>
                            <img src="./assets/imgs/logo_p4h.jpg" alt="" width="
                                200px" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row my-3">
                    <div class="col d-none d-lg-flex justify-content-center align-items-center">
                        <div>
                            <img src="./assets/imgs/logoRISE.jpg" alt="" width="
                                200px" />
                        </div>
                    </div>
                    ...
                    <div class="col references py-5 px-3 subtitle text-white">
                        ...
                        <p>
                            <span class="fw-bold">Site web :</span>
                            <span>
                                <a href="https://rise.passion4humanity.com"
                                    target="_blank">https://rise.passion4humanity.com
                                </a>
                            </span>
                        </p>
                    </div>
        ...
        <div class="py-5">
            ...
            <div class="bg-white d-md-flex justify-content-center align-items-center gap-lg-5 gap-md-2 text-center">
                <div class="row py-2">
                    <div class="col-sm col-md">
                        <a href="#">
                            <img src="./assets/imgs/logo-Maltem.jpg" alt="" width="170px" />
                        </a>
                    </div>

                    <div class="col-sm col-md">
                        <a href="#">
                            <img src="./assets/imgs/logo-Aldinie.jpg" alt="" width="170px" />
                        </a>
                    </div>

                    <div class="col-sm col-md d-flex align-items-center justify-content-center py-3">
                        <a href="#">
                            <img src="./assets/imgs/logo-Akamasoa.jpg" alt="" width="100px" />
                        </a>
                    </div>

                    <div class="col-sm col-md pb-3">
                        <a href="#">
                            <img src="./assets/imgs/logo-Bocasay.jpg" alt="" width="100px" />
                        </a>
                    </div>
                    <div class="col-sm col-md">
                        <a href="#">
                            <img src="./assets/imgs/logo-techzara.jpg" alt="" width="200px" />
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md row">
                        ...
                        <div class="d-flex align-items-center py-3" id="social_media_icons">
                            <div>
                                <a href="https://www.facebook.com/talentfactoryTAFA" target="_blank"
                                    class="text-white pe-3 fs-4">
                                    <i class="fa-brands fa-facebook footer_icons"></i>
                                </a>
                            </div>
                            <div>
                                <a href="https://twitter.com/P4Human" target="_blank" class="text-white px-3 fs-4">
                                    <i class="fa-brands fa-twitter footer_icons"></i>
                                </a>
                            </div>
                            <div>
                                <a href="https://www.instagram.com/tafa_talentfactory/" target="_blank"
                                    class="text-white px-3 fs-4">
                                    <i class="fa-brands fa-instagram footer_icons"></i>
                                </a>
                            </div>
                            <div>
                                <a href="https://www.linkedin.com/company/tafa-talent-factory/" target="_blank"
                                    class="text-white px-3 fs-4">
                                    <i class="fa-brands fa-linkedin footer_icons"></i>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md pt-3">
                        ...
                        <form action="" method="" class="d-flex">
                            <input type="email" class="p-2 me-2" placeholder="votre adresse email" />
                            <input class="px-2" type="submit" value="Envoyer" />
                        </form>
                    </div>
                </div>
            </div>
